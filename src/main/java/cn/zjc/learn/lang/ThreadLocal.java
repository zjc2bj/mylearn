...
/**
 * <pre>
 * 1.调用ThreadLocal.set(value),
 * 2.在Thread.currentThread()当前线程 取出ThreadLocalMap threadLocals集合,
 * 		if(threadLocals == null)  则创建新的ThreadLocalMap 并存入<threadLocal,value>
 * 3.调用ThreadLocalMap.set(ThreadLocal key, Object value)
 * 		指针碰撞问题 TODO 
 * 		。。。
 * </pre>
 */
